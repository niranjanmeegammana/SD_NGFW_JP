...
df = pd.read_csv("log_m2_2.csv", names=column_names, header=None)
...
plt.savefig("multi_testing_time_distribution3.png")  # Save figure
plt.close()
...
plt.savefig("multi_testing_time_boxplot3.png")  # Save figure
plt.close()

print("Figures saved as 'smulti_testing_time_distribution3.png' and 'multi_testing_time_boxplot3.png'")
