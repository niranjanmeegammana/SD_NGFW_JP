...
df = pd.read_csv("log_single2.csv", names=column_names, header=None)
...
plt.savefig("single_testing_time_distribution.png")  # Save figure
plt.close()
...
plt.savefig("single_testing_time_boxplot.png")  # Save figure
plt.close()

print("Figures saved as 'single_testing_time_distribution.png' and 'single_testing_time_boxplot.png'")
