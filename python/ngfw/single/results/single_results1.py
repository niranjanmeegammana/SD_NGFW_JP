...
data = pd.read_csv("log_single.csv ", names=columns)
...
plt.savefig("single_loading_time_distribution.png", dpi=300, bbox_inches="tight")  # Save as PNG
plt.show()
...
plt.savefig("single_speed_vs_loading_time.png", dpi=300, bbox_inches="tight")  # Save as PNG
plt.show()
